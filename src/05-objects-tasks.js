...
const cssSelectorBuilder = {
  ...
  error(selectorId) {
    if (this.selectorId === selectorId && (selectorId === 1 || selectorId === 2 || selectorId === 6)) throw new Error('Element, id and pseudo-element should not occur more then one time inside the selector');
